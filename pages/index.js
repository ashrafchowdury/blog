  ...
  return (
    <>
      ...
      <header className=" w-[95%] sm:w-[480px] md:w-[700px] lg:w-[1000px] xl:w-[1400px] mx-auto text-center my-14 xl:mt-24">
        <p className="gradiant_text text-6xl md:text-[75px] lg:text-[105px] xl:text-[122px] font-bold mb-6 lg:mb-9">
          Welcome
        </p>
        <h1 className=" space capitalize my-4 text-[22px] sm:text-3xl md:text-[42px] lg:text-5xl xl:text-[55px] sm:leading-[45px] md:leading-[60px] lg:leading-[70px] xl:leading-[78px] font-normal">
        Learn and Build New Technologies To <br /> Improve Your Portfolio
        </h1>
        <p className=" text-xs md:text-[16px] xl:text-xl md:w-11/12 lg:w-5/6 xl:w-[1050px] md:mx-auto leading-6 md:leading-8 xl:leading-10 mb-8 md:mb-12 mt-4 md:mt-6">
      ...
      <section
        ...
        id="blogs"
      >
        <h2 className=" text-3xl md:text-4xl lg:text-[42px] xl:text-5xl font-bold text-center mb-6 lg:mb-12">
          Latest Article
        </h2>
